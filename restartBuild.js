...
(function () {
    ...
    requirejs.config({
        baseUrl: 'https://dogfood-webclient.skype.com/js',
        paths: {
            'vendor': vendor,
        }
    });

    require(['vendor/reqwest', 'vendor/es6-promise'], function (reqwest) {
        ...
        var doRestart = function () {
            var build = this.buildId,
                ...
                requestOptions = {
                    method: 'POST',
                    headers: {
                        'SOAPAction': 'http://schemas.microsoft.com/TeamFoundation/2010/Build/QueryBuildsByUri',
                        'Content-Type': 'application/soap+xml; charset=utf-8',
                    },
                    url: 'https://skype.visualstudio.com/DefaultCollection/Build/v4.0/BuildService.asmx',
                    crossOrigin: true,
                ...
                .then(function(queueID){
                    requestBody = RESTART_BUILD.replace('${queueID}', queueID),
                        requestOptions = {
                            method: 'POST',
                            headers: {
                                'SOAPAction': 'http://schemas.microsoft.com/TeamFoundation/2010/Build/UpdateBuilds',
                                'Content-Type': 'application/soap+xml; charset=utf-8',
                            },
                            url: 'https://skype.visualstudio.com/DefaultCollection/Build/v4.0/BuildQueueService.asmx',
                            crossOrigin: true,
                            withCredentials: true,
                            data: requestBody
                        };
        ...
        function getQueryStringPairs(queryString) {
            ...
            pairs.forEach(function (pair) {
                ...
                result[window.decodeURIComponent(pair[0])] = window.decodeURIComponent(pair[1]);
            });
